//As taken from the Unity Community Wiki
//All credit goes to the users who contributed to the Triangular page - http://wiki.unity3d.com/index.php?title=Triangulator
//And, in particular, those users who contributed to the C# code on said page
